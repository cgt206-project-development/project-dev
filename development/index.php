...
<!-- Page: index.php -->
	...
	<div class="fifty-fifty-container">
		...
		<section>
			...
			<ul>
				...
				<li>¡Adelante! America Youth - Jennifer Cazares</li>
				...
				<li>Partnerships - Diana Perez</li>
				<li>Young Adult advisors - Alex Gordon, Deb Robertson</li>
				<li>Young Adult leaders - Eveling Ramirez, Mariellen Ramirez, Alica Torres
				Youth Council sponsor - Amy Ruger</li>
			</ul>
		</section>
		<section class="sixty">
	...
	<div>
		<section class="fifty-fifty-container">
			...
			<p class="fifty-fifty">
				Today the League of United Latin American Citizens is the oldest and most widely respected Hispanic civil rights organization in the United States. The founders of LULAC created an organization that empowers its members to create and develop opportunities where they are needed most. <a href="http://lulac.org/about/history/">Learn more</a> about the history of LULAC.
			</p>
			<p class="fifty-fifty">
