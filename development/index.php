...
<!-- Page: index.php -->
	...
	<div class="three-col-container">
		...
		<section class="three-col">
			...
			<img src="images/index_images/community.jpg" alt="Southwest Washington LULAC showing support of justice and dignity for all US immigrants." class="full-img">
		</section>
		<section class="three-col">
			<h3><a href="partners.php">Partners</a></h3>
			<img src="images/index_images/partners.jpg" alt="Picnic with Vancouver Police." class="full-img">
		</section>
	</div>
	<div class="clearFix"></div>

	<section class="fifty-fifty-container">
		<!-- <section class="sixty"> -->
			<h3>LULAC in the Pacific Northwest</h3>
			<p>
			...
			<p>
				Southwest WA LULAC Council out of Vancouver, WA and LULAC of Lane County out of Eugene, OR have been working together to deliver the mission of LULAC in the Pacific Northwest.  If you are interested in formalizing a LULAC Council in your area please visit <a href="http://lulac.org/members/">LULAC Members</a> for instructions and contact Diana Perez at roseprez13@gmail.com.  For more information on LULAC of <a href="http://lulaclanecounty.org/">Lane County</a>, OR contact <a href"mailto:jcvalle@lulaclanecounty.org">jcvalle@lulaclanecounty.org</a>.
			</p>
		<!-- </section> -->
	</section>
	<div class="clearFix"></div>
	<h3 class="meeting-info">
		For information on attending a Southwest WA LULAC Council meeting contact <a href="mailto:southwestwashingtonlulac@gmail.com">southwestwashingtonlulac@gmail.com</a>
	</h3>
	<div class="fifty-fifty-container">

		<section>
			<h3>Standing committees in Southwest WA LULAC Council</h3>
			<ul>
				<li>Voter Registration - Juanita Greenway</li>
				<li>Law Enforcement Relations - Wilfredo Collins</li>
				<li>¡Adelante! America Youth - Diana Perez</li>
				<li>Environmental Justice - Hector Hinojosa</li>
				<li>Immigration - Eulalia Soto</li>
				<li>Financial Literacy - Carmen McKibben</li>
				<li>Education - Diana Avalos-Leos</li>
				<li>Fundraising - Javier Navarro</li>
				<li>Young Adult advisors - Alex Gordon, Deb Robertson</li>
				<li>Young Adult leaders - Eveling Ramirez, Mariellen Ramirez, Alica Torres</li>
				<li>Youth Council sponsor - Amy Ruger</li>
			</ul>
		</section>
		<section class="sixty">
			<iframe width="100%" height="315" src="https://www.youtube.com/embed/ZreyAAYqvPE" frameborder="0" allowfullscreen></iframe>
		</section>
	</div>
	<div class="clearFix"></div>
	<div>
		<section>
			...
			<p class="fifty-fifty">
				Today the League of United Latin American Citizens is the oldest and most widely respected Hispanic civil rights organization in the United States. The founders of LULAC created an organization that empowers its members to create and develop opportunities where they are needed most. Learn more about the <a href="http://lulac.org/about/history/">history of LULAC</a>.
			</p>
			<p class="fifty-fifty">
